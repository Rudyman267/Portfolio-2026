...
export const DEFAULT_ANNOTATION_LABEL_STYLE: LabelStyle = {
...
export const DEFAULT_ANNOTATION_MARKER_STYLE: MarkerStyle = {
  image:
...
export const DEFAULT_ANNOTATION_POLYLINE_STYLE: PolylineStyle = {
...
export const DEFAULT_ANNOTATION_POLYGON_STYLE: PolygonStyle = {
