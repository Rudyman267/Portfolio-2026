...
import {
  TakeoffMode,
  WaypointData,
} from '@map/public/contracts/feature-entities/missions/linear-mission';

/**
 * Extended options interface for grid mission views that includes polygon vertices
 */
export interface IGridMissionViewOptions {
  /**
  ...
  /**
   * Polygon vertices for grid missions
   * These define the boundary of the grid area
   * Optional - if not provided, no polygon will be displayed
   */
