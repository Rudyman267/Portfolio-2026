...
export const metadata: Metadata = {
  ...
  // The link-preview card. `title` above is the browser-tab brand ("Rudyman"),
  // which is too thin on its own in a shared link — a preview needs to say who
  // this is and what they do, since it is often the first thing anyone sees.
  // The image itself is generated by opengraph-image.tsx.
  openGraph: {
    type: "website",
    url: siteUrl,
    siteName: "Rudyman",
    title: "Riddhiman Deb — AI-native Product Designer",
    description:
      "Product—design builder. I ship both the code and the design.",
  },
  twitter: {
